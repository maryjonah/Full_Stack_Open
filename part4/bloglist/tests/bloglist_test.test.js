...
describe('fav blog', () => {
    test('return fav blog when there are no 2 same likes', () => {
        const blogs = [
            {
    ...
    test('return first blog when multiple blogs have same number of likes', () => {
        const blogs = [
            {
...
describe('mostBlogs', () => {
    test('return top author and number of blogs from a list of blogs', () => {
        const blogs = [
            {
              _id: "5a422a851b54a676234d17f7",
              title: "React patterns",
...
describe('max likes', () => {
    test('return information on author with most likes', () => {
        const blogs = [
            {
              _id: "5a422a851b54a676234d17f7",
              title: "React patterns",
